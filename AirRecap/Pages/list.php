...
<div class="txtmessage" style="background-color:#FED0C7">We will be adding reports that you can recieve on your phone as a text message. If you would like to recieve these reports please edit your profile to add your cell phone number. You can also OPT-OUT of recieving these reports by clicking the opt-out button below:
<br> <a href="/index.php/superweb?eid=<?php echo $EID; ?>&Updateme=1" class="button"><font color=' #b00b55'><u>Edit Profile</u></font></a> <button id="opt-button" class="opt-button" data-url='eid=<?php echo $EID ?>&Status=OPTOUT' >OPT-OUT</button></div>

<?php } ?>
<table><thead><tr><th>
<?php Username($db,$EID); ?> </th></tr></thead></Table>
 <a href="/index.php/superweb?eid=<?php echo $EID; ?>&Updateme=1" class="button"><u>Edit Profile</a></u><?php echo "      " ?><a href="index.php/superweb" class="button"><u><b>Logout</b></u></a>
<?php
echo " <table class='js-table' id='register_form' >  <thead><tr><th><font color='#000000'>Report</th><th><font color='#000000'>Description</th><th><font color='#000000'>SLIC</th><th><font color='#000000'>Add/Remove</th></tr> </thead>
  <tbody >";
...
?> <td data-url="eid=<?php echo $EID; ?>&RPTID=<?php echo $row["rpt_id"];?>&Status=Remove"><div class= "obutton feature2" data-id="<?php echo $row["rpt_id"];?>">
    ...
    <?php if($row["slic_specific"] == true) {  ?>
    <td data-url="NO"><div class= "obutton feature2" data-id="<?php echo $row["rpt_id"];?>">
    <- Select A Slic
    <?php }else{ ?>
<td data-url="eid=<?php echo $EID; ?>&RPTID=<?php echo $row["rpt_id"];?>&Status=Add"><div class= "obutton feature2" data-id="<?php echo $row["rpt_id"];?>">
<a href="../Superweb/Pages/addlist.php?eid=<?php echo $EID; ?>&RPTID=<?php echo $row["rpt_id"];?>&Status=Add"><button  class="reserve-button">Add</button></a>
</div></td> <?php } }
Echo "</td>"; 
 echo "</tr>"; 
