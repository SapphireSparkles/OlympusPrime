...
echo 'Selected Year: <input type="text" style="font-weight: bold;" name="first_field"  size="6"id="first_field"  readonly value = ',$Yrrr,'> ';
echo 'Selected Operation: <input type="text" style="font-weight: bold;" name="Secnd_field"  size="40"  id="Secnd_field" readonly value = ',$OPnam,'> '; 
echo 'Selected Time Frame: <input type="text" style="font-weight: bold;" name="Third_field" size="10" id="Third_field"  readonly value = ',$tmpr,'> <br><br>' ;
