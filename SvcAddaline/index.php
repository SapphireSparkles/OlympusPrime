...
<html>
  ...
  <body> <!--onload="document.frmdropdown.submit()"> -->
  <style type="text/css">
...
<form name="frmdropdown" method="post" >
	 ...
	 $dd_res = $db->query($query); 
	            ...
	            <select id="OpTm" name="OpTm" > 
	             <option value=""></option> 
	            <?php
	  $query = "Select TimePeriod from oe_scv_addaline Where TimePeriod <> 'Daily' Group By TimePeriod"; 
	 $dd_res = $db->query($query); 
            ...
            <?php
  //$query = "Select SLIC from t_SLIC_List Group By SLIC ORDER by SLIC";
