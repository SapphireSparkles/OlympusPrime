...
$allreports =  $db->query('select * from rpt_reports where  ext NOT LIKE  "Portal" and rpt_reports.deactivated = false and  ext NOT LIKE  "Portal"  ORDER BY report ');

//$allreports2 =  $db->query('select * from rpt_reports where rpt_reports.deactivated = false and ext = Portal ORDER BY report ');
